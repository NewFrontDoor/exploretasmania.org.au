                  ...
                  <div className="content">
                    ...
                    <div className="row guide-row">
                      ...
                      <div className="col-md-6 bio-div">
                        ...
                        Patrick has been leading on Christian outdoor camps for more than a decade. In the past he has worked as a guide on the Franklin River and a ski instructor at Cardrona in New Zealand.<br /><br />
                    ...
                    <div className="row guide-row">
                      ...
                      <div className="col-md-6 bio-div">
                        <p className="guide-bio">
                          ...
                          <strong>Why I love God:</strong><br />
                          Because even in my worst moments, in the things I am ashamed of, He loved me so much that he paid the price for what I’ve done so that I can have a relationship with him. Even when I betrayed him, He still sent his son to die for me. 
                        </p>
                      </div>
                    </div>
